...
ggplot(data = sub.org.long, aes(y = proportion, x = lnratio)) + geom_ribbon(data =pom.quants,  aes(x = ln, y= lower, ymin = lower, ymax = upper), stat="identity", col = "blue", alpha = 0.2) + ylim(0,0.7)
 ```
